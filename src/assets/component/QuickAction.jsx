...
const QuickActions = () => {
  const actions = [
    { label: 'Add New Student', icon: Users, color: 'bg-blue-600 hover:bg-blue-700' },
    { label: 'Create Course', icon: BookOpen, color: 'bg-green-600 hover:bg-green-700' },
    { label: 'Schedule Class', icon: Calendar, color: 'bg-purple-600 hover:bg-purple-700' },
